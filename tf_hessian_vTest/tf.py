...
def getHessianMLP(w, n_input, n_hidden, n_output):
    batch_size = 3
...
if __name__ =='__main__':
    w = [0.1, 0.2, 0.1, 0.05, -0.1, 0.1, 0.3, -0.2, 0.1, 0, 0, 0, -0.2, -0.05, -0.1, 0.2, 0.1, 0.1, 0.3, -0.2, 0.1,
         0, 0, 0]
    w = [[y] for y in w]

    epochs = range(100)
    for epoch in epochs:
        Hessian, dloss_dw, loss, hidden2 = getHessianMLP(w, n_input=3, n_hidden=3, n_output=3)
        # print(Hessian)
        # print(dloss_dw)
        print(loss)
